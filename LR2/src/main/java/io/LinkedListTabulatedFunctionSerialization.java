...
public class LinkedListTabulatedFunctionSerialization {
    public static void main(String args[]) {
        try (BufferedOutputStream out = new BufferedOutputStream(new FileOutputStream("C:\\Users\\User\\IdeaProjects\\LRGit\\LR2\\output\\serialized linked list functions.bin"))) {
            double[] xValue = {1, 2, 3};
            double[] yValue = {4, 5, 6};
        ...
        try (BufferedInputStream in = new BufferedInputStream(new FileInputStream("C:\\Users\\User\\IdeaProjects\\LRGit\\LR2\\output\\serialized linked list functions.bin"))) {
